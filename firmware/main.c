...
int main(void){
    ...
    while(42){
        uint16_t ch1 = results[PIEZO_HIGHEST_CHANNEL-PIEZO_1_CH];
        uint16_t ch2 = results[PIEZO_HIGHEST_CHANNEL-PIEZO_2_CH];
        uint16_t ch3 = results[PIEZO_HIGHEST_CHANNEL-PIEZO_3_CH];
        uart_putc('R');
        uart_putc(' ');
        uart_putadc(ch1);
        uart_putc(' ');
